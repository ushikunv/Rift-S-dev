...
public class OVRGrabbable : MonoBehaviour
{
    ...
    private List<OVRGrabber> enteredGrabber = new List<OVRGrabber>();
    ...
    public void NotifyEnter(OVRGrabber grabber){
        enteredGrabber.Add(grabber);
    }

    public void NotifyExit(OVRGrabber grabber){
        enteredGrabber.Remove(grabber);
    }

    public void NotifyToGrabber(){
        foreach(OVRGrabber grabber in enteredGrabber){
            grabber.ForceTriggerExit(GetComponent<Collider>());
        }
